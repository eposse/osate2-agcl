 ...
 * <ul>
 *   <li>{@link org.osate.xtext.aadl2.agcl.analysis.verifiers.impl.UnknownImpl#getReason <em>Reason</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnknownImpl extends MinimalEObjectImpl.Container implements Unknown {
	...
	protected EClass eStaticClass() {
		return VerifiersPackage.Literals.UNKNOWN;
	}
	...
	public void setReason(String newReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VerifiersPackage.UNKNOWN__REASON, oldReason, reason));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VerifiersPackage.UNKNOWN__REASON:
				return getReason();
		}
