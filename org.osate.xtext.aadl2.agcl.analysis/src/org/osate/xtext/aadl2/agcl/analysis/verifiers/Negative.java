...
public interface Negative extends VerificationResult {
	/**
	 * Returns the value of the '<em><b>Counterexample</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Counterexample</em>' reference.
	...
	/**
	 * Sets the value of the '{@link org.osate.xtext.aadl2.agcl.analysis.verifiers.Negative#getCounterexample <em>Counterexample</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Counterexample</em>' reference.
