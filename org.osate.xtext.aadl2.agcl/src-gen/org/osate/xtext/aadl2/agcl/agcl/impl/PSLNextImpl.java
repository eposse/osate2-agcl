 ...
 * <ul>
 *   <li>{@link org.osate.xtext.aadl2.agcl.agcl.impl.PSLNextImpl#getSubterm <em>Subterm</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PSLNextImpl extends PSLExpressionImpl implements PSLNext
{
  ...
  public NotificationChain basicSetSubterm(PSLExpression newSubterm, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AgclPackage.PSL_NEXT__SUBTERM, oldSubterm, newSubterm);
  ...
  public void setSubterm(PSLExpression newSubterm)
  {
    if (newSubterm != subterm)
    {
      ...
      if (subterm != null)
        msgs = ((InternalEObject)subterm).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AgclPackage.PSL_NEXT__SUBTERM, null, msgs);
      if (newSubterm != null)
        msgs = ((InternalEObject)newSubterm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AgclPackage.PSL_NEXT__SUBTERM, null, msgs);
      msgs = basicSetSubterm(newSubterm, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgclPackage.PSL_NEXT__SUBTERM, newSubterm, newSubterm));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AgclPackage.PSL_NEXT__SUBTERM:
